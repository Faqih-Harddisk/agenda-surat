...
'filesystems.disks.s3.report','filesystems.links.C:\\laragon\\www\\agenda-surat\\public\\storage','logging.default','logging.deprecations.channel','logging.deprecations.trace',
...
'signed','throttle','verified','check.login',);
...
'landing','layouts.app','layouts.guest','layouts.navigation','login',
'profile.edit','profile.partials.delete-user-form','profile.partials.update-password-form','profile.partials.update-profile-information-form','surat.create',
'surat.edit','surat.index','welcome','laravel-exceptions-renderer::components.badge','laravel-exceptions-renderer::components.empty-state',
